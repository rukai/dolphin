...
WiiTASInputWindow::WiiTASInputWindow(QWidget* parent, int num) : QDialog(parent), m_num(num)
{
  ...
  m_ir_x_value = CreateSliderValuePair(this, x_layout, IRWidget::m_max_x, Qt::Key_F, Qt::Horizontal,
                                       m_ir_box, true);

  auto* y_layout = new QVBoxLayout;
  m_ir_y_value = CreateSliderValuePair(this, y_layout, IRWidget::m_max_y, Qt::Key_G, Qt::Vertical,
                                       m_ir_box, true);
  ...
  m_ir_x_value->setValue(IRWidget::m_max_x / 2);
  m_ir_y_value->setValue(IRWidget::m_max_y / 2);

  auto* visual_ar = new AspectRatioWidget(visual, IRWidget::m_max_x, IRWidget::m_max_y);
